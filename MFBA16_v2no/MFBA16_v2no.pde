...
void setup() {
    ...
    fullScreen();
    //size(100, 100);  //1920 x 1080 HD camera resolution 1920, 1440
...
void draw() {
 ...
 // byte val;
  ...
  if(key == 'A') {  // once the button is pressed...
    ...
    Process run = Runtime.getRuntime().exec("osascript /Users/karenmikuni/Desktop/thermal-printer/mfba_printer.scpt");
...
void getImage() {
    ...
    for (int y = 1; y < img.height-1; y++) { // Skip top and bottom edges
      ...
      finalpic.save("thisisdithered.png");  // save the processed image
...
void createFile() {
  ...
  filename = "photo";
  image = loadImage("thisisdithered.png");
         ...
         case  XM_WAIT :
          ...
          case XM_RUN:
              ...
              if(buffer_index < IMAGE_SIZE) // used to be IMAGE_SIZE -128
                {
                  format_xmframe(temp_image,buffer_index);
